    ...
    <main className="min-h-screen bg-gelap text-white">
      ...
      <section className="px-6 py-10 max-w-3xl mx-auto">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          {[
            ...
            { label: "Gelap",   hex: "#0a0a0a" },
            { label: "White",   hex: "#FFFFFF" },
            { label: "Gray",    hex: "#737373" },
          ].map((c) => (
            <div key={c.label} className="flex items-center gap-2">
              <span
                className="h-9 w-9 rounded-lg border border-gelap-300"
      ...
      <section className="px-6 py-10 max-w-3xl mx-auto">
        ...
        <div className="mt-4 rounded-2xl border border-gelap-200 bg-gelap-100 p-8">
          <div className="text-7xl font-extrabold leading-none">Aa</div>
          <div className="mt-4 text-3xl font-semibold">Poppins</div>
      ...
      <footer className="border-t border-gelap-200 px-6 py-10 flex justify-center">
        <div className="card-dark flex items-center gap-4 max-w-2xl">
          ...
          <div>
            <div className="font-bold">Sécurisé. Vérifié. Contrôle par vous.</div>
